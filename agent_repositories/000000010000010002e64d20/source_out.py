...
if 1 == 0:
    ...
    if result == true:
        ...
        """Tell sender import was successful"""
        send_message("Your data was successfully imported into our database", sender)
    else:
        """Tell sender that import has failed"""
        send_message("Data import failed, please review attachment content", sender)
else:
    """Tell sender attachment is needed"""
    send_message("The message needs to have an excel attachment", sender)
    """Start over"""
...
function_1_declaration("Param 1_1 value", "Param 1_2 value")
